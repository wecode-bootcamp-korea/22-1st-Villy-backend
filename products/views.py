        ...
        try: 
            ...
            results = [{
                    "products" : [{
                            ...
                            "icon_image_url"     : [product_icon.icon_url for product_icon in Product.objects.get(id=product.id).productefficacy_set.all()],
    ...
    def get(self, request, product_id):
        try:
            ...
            results = [{
                    ...
                    "icon_image_url"     : [product_icon.icon_url for product_icon in product.productefficacy_set.all()],
